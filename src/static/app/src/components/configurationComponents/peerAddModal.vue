					...
					<div class="card-body px-4 pb-4">
						<div class="d-flex flex-column gap-2">
							...
							<div v-if="peerData.bulkAdd">
								<label for="bulk_peer_quota_gb" class="form-label mb-1">
									<small class="fw-bold"><LocaleText t="Data Quota for each peer"></LocaleText> (GB)</small>
								</label>
								<input id="bulk_peer_quota_gb" v-model.number="peerData.quota_gb" type="number"
							...
							<template v-if="!peerData.bulkAdd">
								...
								<div>
									<label for="peer_quota_gb" class="form-label mb-1">
										<small class="fw-bold"><LocaleText t="Data Quota"></LocaleText> (GB)</small>
									</label>
									<input id="peer_quota_gb" v-model.number="peerData.quota_gb" type="number"
									       min="0" step="0.1" :disabled="saving"
									       class="form-control form-control-sm rounded-3">
									<small class="text-muted"><LocaleText t="Set to 0 for unlimited traffic"></LocaleText></small>
								</div>
