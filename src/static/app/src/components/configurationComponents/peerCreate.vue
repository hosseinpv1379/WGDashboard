...
<template>
	<div class="container">
		...
		<div class="d-flex flex-column gap-2">
			...
			<div>
				<label for="peer_create_quota_gb" class="form-label mb-1">
					<small class="fw-bold"><LocaleText :t="this.data.bulkAdd ? 'Data Quota for each peer' : 'Data Quota'"></LocaleText> (GB)</small>
				</label>
				<input id="peer_create_quota_gb" v-model.number="this.data.quota_gb" type="number"
