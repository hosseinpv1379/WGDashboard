...
import ClientCreate from "@/components/clientComponents/clientCreate.vue";
	...
	<div class="text-body w-100 h-100 pb-2 position-relative">
		...
		<div class="w-100 h-100 card rounded-3">
			<Transition name="zoom">
				<ClientCreate v-if="creatingClient" @close="creatingClient = false" @created="clientCreated"></ClientCreate>
			</Transition>
			<Transition name="zoom">
			...
			<div class="border-bottom z-0">
				<div class="d-flex text-body align-items-center sticky-top p-3 bg-body-tertiary rounded-top-3" style="border-top-right-radius: 0 !important;">
					...
					<button class="btn bg-primary-subtle text-primary-emphasis ms-auto rounded-3 btn-sm"
					        @click="creatingClient = true">
						<i class="bi bi-person-plus-fill me-2"></i>
						<LocaleText t="Create Client"></LocaleText>
					</button>
					<button class="btn btn-body bg-body-secondary rounded-3 btn-sm" @click="settings = !settings">
